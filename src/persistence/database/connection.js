 ...
 * older one is walked forward by the migration scripts (v1 → v10), and the
...
import { CALL_TASK_STATUS, MIGRATION_V2, MIGRATION_V3, MIGRATION_V4, MIGRATION_V5, MIGRATION_V6, MIGRATION_V7, MIGRATION_V8, MIGRATION_V9, MIGRATION_V10, SCHEMA } from './schema.js';
...
export class Database {
  constructor(file) {
    ...
    if (version >= 1 && version <= 9) this.migrateV10();
  ...
  /** Add the intension queue (see `MIGRATION_V10`). */
  migrateV10() {
    this.script(MIGRATION_V10);
  }
