...
const MUTATIONS = new Set(['input.submit','input.flow','draft.add','draft.remove','draft.commit','task.message','task.cancel','task.retry','task.merge','task.merge_many','task.cleanup','task.verify','task.clear','notice.answer','notice.dismiss']);
