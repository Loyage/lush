    ...
    async fetch(request, server) {
      ...
      try {
        ...
        if (request.method === 'GET') {
          ...
          const reading = /^\/api\/task\/(\d+)\/(transcript-search|transcript-step|explanations)$/.exec(url.pathname);
          if (reading) {
