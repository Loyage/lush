...
/** 左栏的五个区块：导航条、折叠状态、筛选条都按这个顺序走。 */
export const SIDEBAR_SECTIONS = [
  { id: 'drafts', label: '缓存', long: '待提交缓存' },
  { id: 'intents', label: '意图', long: '意图' },
  { id: 'tasks', label: '任务树', long: '任务树' },
  { id: 'specs', label: '队列', long: '拆解队列' },
  { id: 'notices', label: '待决', long: '等你决定' },
];
