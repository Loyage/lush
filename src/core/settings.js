 ...
 * 未被覆盖的键不写进文件，也不用假值填充。
 */
export const RUNTIME_SETTINGS_KEYS = ['concurrency', 'control_concurrency'];
...
export class RuntimeSettings {
  ...
  get() {
    ...
    for (const key of RUNTIME_SETTINGS_KEYS) {
      ...
      model[key] = { value: overridden ? stored[key] : this.defaults[key], default: this.defaults[key], overridden };
    }
    return model;
  }
