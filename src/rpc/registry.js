...
export const PARAMS = {
  'system.status': [], 'system.stop': [], 'system.timeline': ['limit'], 'agent.config': [], 'agent.models': ['agent'], 'agent.resources': [], 'agent.configure': ['config'],
  'input.submit': ['content','branch'], 'input.list': [], 'input.flow': ['id','flow'],
