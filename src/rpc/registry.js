...
export const PARAMS = {
  ...
  'task.reserve': ['id','kind'], 'task.resolve_divergence': ['id'], 'task.resolve_child_divergence': ['id'], 'task.analyze': ['id','question'], 'task.unreserve': ['id'], 'task.approve_merge': ['id','commit','baseline'], 'task.message': ['id','body'], 'task.cancel': ['id'], 'task.retry': ['id','profile'],
