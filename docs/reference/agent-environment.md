...
以下操作限用户：system.stop、system.configure、agent.configure、input.submit、task.cancel/retry/merge/cleanup/clear、branch.import/merge/sync/archive、notice.answer/dismiss。CLI 另禁止 agent 启动 daemon、Web 或阻塞等待。
