...
| `project/showcase.js` | 效果展示 Task 创建、固定上下文、报告校验、有界列表与预览启停 | `startShowcase`、`showcases`、`showcaseContext`、`prepareShowcaseReport`、`showcaseReport`、`startShowcasePreview`、`stopShowcasePreview` |
