...
| `workspaces/showcase.js` | 已登记非主干准入、精确本地 ref / 起点解析、实际改动与工作区 / Git 中间态校验、固定提交树有界缓存、隔离 detached 检出及复用校验；不拥有或删除源分支 | `showcaseSnapshot`、`showcaseTree`、`showcaseCleanBranches`、`assertShowcaseCheckout`、`ensureShowcase` |
